...
const rootHandoff = read("docs/florida-class-d-lms/HANDOFF.md");
const gate9Handoff = read("docs/florida-class-d-lms/GATE-9-PARTICIPATION-HANDOFF.md");
...
requireText(rootHandoff, "# Obserra Florida Class D LMS Handoff", "Gate 9 must remain anchored to the authoritative Florida Class D LMS handoff area.");
requireText(rootHandoff, "It is separate from the commercial Obserra Academy", "Gate 9 must remain separate from commercial Academy course production.");
requireText(gate9Handoff, "## Gate 9 — Structured Live Polls and Participation Analytics", "The dedicated Class D Gate 9 handoff must record polling and analytics controls.");
requireText(gate9Handoff, "These analytics are instructional and participation evidence only", "Gate 9 handoff must preserve the boundary between participation analytics and regulated attendance/completion credit.");

console.log("Florida Class D Gate 9 passed: structured live polls, one-response controls, student-safe payloads, instructor analytics, participation evidence, and controlled handoff records validated in source.");
