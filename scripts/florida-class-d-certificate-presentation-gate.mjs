...
assert(service.includes("Supplemental Course Completion Record") && service.includes("does not establish FDACS approval, professional certification, or a Florida Class D Security Officer license"), "supplemental completion record must clearly distinguish itself from the official Florida certificate and professional certification");
