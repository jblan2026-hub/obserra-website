...
if (source.websiteCredentialRemediation?.candidateSource?.publicationState !== "not_published" || source.websiteCredentialRemediation?.candidateSource?.authoritativeTechnicalState !== "not_tested" || source.websiteCredentialRemediation?.candidateSource?.eligibleAsFinalEvidence !== false || source.websiteCredentialRemediation?.candidateSource?.exactReleaseCommitSha !== null) fail("unpublished website candidate is mislabeled as final or green");
...
const lines = [
  ...
  "",
  `The candidate remains \`${source.websiteCredentialRemediation.candidateSource.publicationState}\` and is not final evidence. It contains ${source.websiteCredentialRemediation.candidateSource.authorizedCredentialCount} authorized local assets, ${source.websiteCredentialRemediation.candidateSource.credentialHolderAuthorizedUploadCount} exact credential-holder uploads, and ${source.websiteCredentialRemediation.candidateSource.liveVerifiedAdgObservationCount} live Active ADG issuer observations.`,
  "",
