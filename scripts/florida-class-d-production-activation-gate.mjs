...
for (const [value, message] of [
  ...
  ["OBSERRA_FDACS_SUPABASE_URL", "protected database origin must be required"],
  ["OBSERRA_FDACS_SUPABASE_SERVICE_ROLE_KEY", "protected database service credential must be required"],
