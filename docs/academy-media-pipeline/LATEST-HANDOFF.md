...
Approved owner title: Founder and CEO
...
1. Credentials or token material.
2. Learner or customer data.
3. Assessment answers.
4. Raw avatar or voice-clone source material.
5. Confidential course manuscripts or unreleased source content.
6. Detailed incident evidence or private security architecture.
7. Private provider, database, or deployment configuration.
...
Any video showing a different person, a regenerated or modified owner face, a merely similar voice, a wrong owner, or a wrong title is rejected and must not be loaded into LearnWorlds.
...
## Rejected-video cleanup state

```text
Wrong-person generated owner-welcome asset: deleted
Direct retrieval of deleted asset: not found
Active HeyGen video inventory after cleanup: zero active items
Older pending test references: not retrievable
Historical failed Video Agent session metadata: may remain visible as a record only
Approved owner source video: not deleted or modified
```

Historical session metadata is not an active video asset and is prohibited from course use.
...
4. Use only Dr. Jody Blanchard, Founder and CEO, with OBSERRA EXECUTIVE PROTECTION & INTELLIGENCE LLC and https://www.obserrallc.com.
5. Complete the corrected 4K owner introduction with the approved transcript, official logo, exact lower third, professional speech cleanup, captions, and verified transcript.
...
8. Complete current-head CI and protected runtime validation.
9. Complete credential rotation and forensic review.
10. Change this repository to private and review public-history exposure.
