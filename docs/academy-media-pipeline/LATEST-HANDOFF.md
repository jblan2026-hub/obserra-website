...
Use as many appropriate LearnWorlds native activity types as improve learning quality. Appropriate elements include branded sections, the exact owner introduction, substantive lesson and interactive videos, eBooks or formatted lessons, downloadable PDFs and job aids, guided practice, reflection, assignments, forms, knowledge checks, quizzes, self-assessments, scenario questions, SCORM when it adds measurable value, final assessment controls, completion rules, certificate controls, captions, transcripts, and accessibility artifacts.

Include authoritative references where they directly support learning objectives, including appropriate official NIST publications and other primary guidance. Placeholder activities, empty sections, zero-duration shells, generic filler, and decorative resources are prohibited.
