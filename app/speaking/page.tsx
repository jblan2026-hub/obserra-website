...
export default function SpeakingPage() {
  return <main className="speaker-page">
    ...
    <section className="speaker-gallery"><p className="speaker-kicker">SELECTED COMPLETED ENGAGEMENTS</p><h2>Experienced perspective in public leadership conversations.</h2><div className="speaker-gallery-grid">
      <article><Image src="/leadership/technology-talks-no-employer.png" width={720} height={480} alt="Dr. Jody Blanchard at the CNBC Technology Executive Council TEC Talk on December 12, 2024" /><h3>CNBC Technology Executive Council TEC Talk</h3><p>Completed December 12, 2024, on upskilling the workforce in the age of artificial intelligence.</p></article>
      <article><Image src="/leadership/fireside-chat-neutral.png" width={720} height={480} alt="Dr. Jody Blanchard at the ISE East Summit and Awards cybersecurity return on investment fireside chat" /><h3>Cybersecurity ROI: Transforming Security Expenditure into Business Growth in a Time of Economic Uncertainty</h3><p>Completed ISE East Summit &amp; Awards fireside discussion on measurable security value.</p></article>
      <article><Image src="/leadership/global-leadership-award-2025.png" width={720} height={480} alt="Dr. Jody Blanchard HMG Strategy Global Leadership Institute Awards 2025 winner recognition" /><h3>HMG Strategy Global Leadership Institute Awards, 2025</h3><p>Named a 2025 winner for executive leadership in cybersecurity and enterprise risk governance.</p></article>
    </div></section>
    ...
    <section className="speaker-recognition"><div><p className="speaker-kicker">RECOGNITION</p><h2>Recognized executive leadership and cybersecurity impact.</h2></div><div className="speaker-recognition-card"><Image src="/leadership/ceh-hall-of-fame-2025.png" width={680} height={848} alt="Dr. Jody Blanchard CEH Hall of Fame 2025 magazine cover" /><div><span>CEH HALL OF FAME · TOP 100</span><h3>CEH Hall of Fame 2025 magazine cover</h3><p>EC-Council recognition for outstanding performance and contribution to ethical hacking, supported by the official badge, certificate, and issuer verification on the About page.</p><Link href="/about#ceh-hall-of-fame-title">Review the verified Hall of Fame award</Link></div></div></section>
