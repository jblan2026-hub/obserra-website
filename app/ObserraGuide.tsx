...
function answer(question: string): Message {
  ...
  if (/protect|executive|travel|threat/.test(input)) return { from: "guide", text: "Obserra provides protective intelligence, travel risk support, executive focused security planning, and risk advisory services.", href: "mailto:info@obserrallc.com?subject=Obserra%20Consultation", label: "Contact Obserra" };
  ...
  if (/service|help|contact|speak|quote/.test(input)) return { from: "guide", text: "For a service inquiry, training for a team, or a confidential consultation, use the contact page and select the area that fits your need.", href: "mailto:info@obserrallc.com?subject=Obserra%20Consultation", label: "Contact Obserra" };
