...
function answer(question: string): Message {
  ...
  if (/pay|price|buy|checkout|enroll/.test(input)) return { from: "guide", text: "Each Academy course has its own secure checkout. Choose a course, select Purchase secure enrollment, and pay through Stripe. After payment is verified, create or sign in to your separate Academy account with the same email address to unlock your course.", href: "/academy#courses", label: "Choose a course" };
