...
const specs: CourseSpec[] = [
  ...
  ["coding-for-cyber-leaders", "Coding Fundamentals for Cybersecurity Leaders", "Foundation", "Technologies", ACADEMY_BRAND_NAME, "technical fluency for leaders who govern cyber automation and engineering work"],
  ["python-security-automation", "Python for Security, Risk, and Automation", "Professional", "Technologies", ACADEMY_BRAND_NAME, "safe automation design, data handling, and security use cases with Python"],
  ["api-security-integration", "API Security and Enterprise Integration", "Professional", "Technologies", ACADEMY_BRAND_NAME, "secure API design, integration governance, and service accountability"],
  ...
  ["low-code-security-automation", "Low Code Automation for Business and Security Teams", "Professional", "Technologies", ACADEMY_BRAND_NAME, "governed automation, safe approval paths, and measurable process improvement"],
  ...
  ["executive-dashboards-data-ai", "Building Executive Dashboards with Data and AI", "Professional", "Technologies", ACADEMY_BRAND_NAME, "decision-ready metrics, explainable AI summaries, and executive dashboard design"],
  ...
  ["secure-ai-native-apps", "Secure AI Native Business Applications", "Advanced", "Technologies", ACADEMY_BRAND_NAME, "secure-by-design AI-native application architecture and operational controls"],
  ["secure-software-development-lifecycle", "Secure Software Development Lifecycle", "Advanced", "Technologies", ACADEMY_BRAND_NAME, "secure engineering practices, assurance evidence, and release discipline"],
  ["cloud-native-app-security", "Cloud Native Application Security", "Advanced", "Technologies", ACADEMY_BRAND_NAME, "cloud-native threat reduction, resilient delivery, and runtime safeguards"],
  ["devsecops-enterprise-teams", "DevSecOps for Enterprise Teams", "Advanced", "Technologies", ACADEMY_BRAND_NAME, "integrated development, security, operations, and evidence-backed release controls"],
  ...
  ["eios-enterprise-intelligence-overview", "EIOS Enterprise Intelligence Operating System Overview", "CISO Masterclass", "Technologies", ACADEMY_BRAND_NAME, "enterprise intelligence, governed orchestration, digital twin context, and verified outcomes"],
  ...
  ["custom-ai-native-app-strategy", "Custom AI Native Application Strategy", "CISO Masterclass", "Technologies", ACADEMY_BRAND_NAME, "AI-native product strategy, architecture choices, governance, and measurable value"],
...
function createModules(title: string, focus: string, level: CourseLevel): Course["modules"] {
  ...
  return phases.map((phase, index) => ({
    ...
    description: `Original ${ACADEMY_BRAND_NAME} instruction on ${focus}. Learners work through context, evidence, trade-offs, and an accountable next action.`,
  }));
}
