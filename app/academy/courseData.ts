...
const specs: CourseSpec[] = [
  ...
  ["coding-for-cyber-leaders", "Coding Fundamentals for Cybersecurity Leaders", "Foundation", "Technologies", "Obserra EPI Academy", "technical fluency for leaders who govern cyber automation and engineering work"],
  ["python-security-automation", "Python for Security, Risk, and Automation", "Professional", "Technologies", "Obserra EPI Academy", "safe automation design, data handling, and security use cases with Python"],
  ["api-security-integration", "API Security and Enterprise Integration", "Professional", "Technologies", "Obserra EPI Academy", "secure API design, integration governance, and service accountability"],
  ...
  ["low-code-security-automation", "Low Code Automation for Business and Security Teams", "Professional", "Technologies", "Obserra EPI Academy", "governed automation, safe approval paths, and measurable process improvement"],
  ...
  ["executive-dashboards-data-ai", "Building Executive Dashboards with Data and AI", "Professional", "Technologies", "Obserra EPI Academy", "decision-ready metrics, explainable AI summaries, and executive dashboard design"],
  ...
  ["secure-ai-native-apps", "Secure AI Native Business Applications", "Advanced", "Technologies", "Obserra EPI Academy", "secure-by-design AI-native application architecture and operational controls"],
  ["secure-software-development-lifecycle", "Secure Software Development Lifecycle", "Advanced", "Technologies", "Obserra EPI Academy", "secure engineering practices, assurance evidence, and release discipline"],
  ["cloud-native-app-security", "Cloud Native Application Security", "Advanced", "Technologies", "Obserra EPI Academy", "cloud-native threat reduction, resilient delivery, and runtime safeguards"],
  ["devsecops-enterprise-teams", "DevSecOps for Enterprise Teams", "Advanced", "Technologies", "Obserra EPI Academy", "integrated development, security, operations, and evidence-backed release controls"],
  ...
  ["eios-enterprise-intelligence-overview", "EIOS Enterprise Intelligence Operating System Overview", "CISO Masterclass", "Technologies", "Obserra EPI Academy", "enterprise intelligence, governed orchestration, digital twin context, and verified outcomes"],
  ...
  ["custom-ai-native-app-strategy", "Custom AI Native Application Strategy", "CISO Masterclass", "Technologies", "Obserra EPI Academy", "AI-native product strategy, architecture choices, governance, and measurable value"],
...
function createModules(title: string, focus: string, level: CourseLevel): Course["modules"] {
  ...
  return phases.map((phase, index) => ({
    ...
    description: `Original Obserra EPI Academy instruction on ${focus}. Learners work through context, evidence, trade-offs, and an accountable next action.`,
  }));
}
...
function createCourse([id, title, level, department, track, focus]: CourseSpec): Course {
  return {
    ...
    description: `An original Obserra EPI Academy ${level.toLowerCase()} course focused on ${focus}. It uses practical decision scenarios, knowledge checks, and accountable application—not third-party certification material.`,
