...
export const industrySolutions: IndustrySolution[] = [
  {
    ...
    executiveOverview: `Healthcare leaders must balance patient safety, operational continuity, privacy, cyber resilience, and rapid technology adoption. ${LEGAL_ENTITY_NAME} connects those priorities into one executive decision framework.`,
  ...
  },
  {
    ...
    executiveOverview: `Medical-device organizations operate where patient safety, product quality, cybersecurity, regulatory evidence, and software supply-chain integrity converge. ${LEGAL_ENTITY_NAME} helps leadership govern those risks as one enterprise system.`,
  ...
  },
  {
    ...
    executiveOverview: `Pharmaceutical enterprises require integrated governance across research, manufacturing, privacy, cyber resilience, supply chains, and executive risk. ${LEGAL_ENTITY_NAME} delivers a unified operating view for those dependencies.`,
  ...
  },
  {
    ...
    executiveOverview: `Financial institutions require continuous assurance across cybersecurity, resilience, identity, third parties, AI, and regulatory obligations. ${LEGAL_ENTITY_NAME} translates those demands into prioritized executive action.`,
  ...
  },
  {
    ...
    executiveOverview: `Insurers face simultaneous exposure as regulated enterprises, data custodians, risk underwriters, and AI adopters. ${LEGAL_ENTITY_NAME} helps leadership integrate those perspectives into defensible decisions.`,
  ...
  },
  {
    ...
    executiveOverview: `Manufacturers depend on tightly coupled enterprise, plant, supplier, product, and logistics ecosystems. ${LEGAL_ENTITY_NAME} gives leadership one consequence-aware view of those interdependencies.`,
  ...
  },
  {
    ...
    executiveOverview: `Energy and utility organizations operate essential services where cyber, physical, geopolitical, environmental, and supply-chain risks intersect. ${LEGAL_ENTITY_NAME} unifies those signals for executive action.`,
  ...
  },
  {
    ...
    executiveOverview: `Critical-infrastructure leaders must make rapid decisions with incomplete information and high consequences. ${LEGAL_ENTITY_NAME} brings cross-domain intelligence, governance, and response priorities into one operating picture.`,
  ...
  },
  {
    ...
    executiveOverview: `Technology companies must move quickly while maintaining customer trust, secure development, platform resilience, privacy, and responsible AI. ${LEGAL_ENTITY_NAME} converts those requirements into scalable governance.`,
  ...
  },
  {
    ...
    executiveOverview: `Government organizations require secure, accountable, and resilient operations across mission systems, personnel, suppliers, data, and emerging technology. ${LEGAL_ENTITY_NAME} provides decision support without overstating authorization status.`,
  ...
  },
  {
    ...
    executiveOverview: `Defense organizations and suppliers must protect missions, people, controlled information, technology, and complex supply chains. ${LEGAL_ENTITY_NAME} aligns enterprise risk, cyber assurance, intelligence, and executive decision support.`,
  ...
  },
  {
    ...
    executiveOverview: `Higher-education institutions combine open access, sensitive research, diverse populations, distributed technology, and public-facing leadership. ${LEGAL_ENTITY_NAME} helps institutions govern those competing priorities without losing mission focus.`,
