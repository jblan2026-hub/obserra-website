...
export default function AboutPage() {
  const aboutSchema = {
    ...
    "@graph": [
      ...
      { "@type": "Book", name: OBSERRIAN_DOCTRINE.fullTitle, isbn: OBSERRIAN_DOCTRINE.isbn, image: `https://www.obserrallc.com${OBSERRIAN_DOCTRINE.coverPath}`, url: OBSERRIAN_DOCTRINE.amazonUrl, author: { "@type": "Person", name: OBSERRIAN_DOCTRINE.author }, identifier: { "@type": "PropertyValue", propertyID: "ASIN", value: OBSERRIAN_DOCTRINE.asin } },
    ],
  };
  ...
  return (
    <>
      ...
      <main className="about-page about-executive-page enterprise-page-main">
        ...
        <section className="about-proof-section about-proof-credentials" aria-labelledby="credentials-heading"><div className="about-proof-heading"><div><p className="about-kicker">VERIFIED CREDENTIALS &amp; LICENSES</p><h2 id="credentials-heading">Credentials grounded in recognized standards.</h2></div><p>Issuer-backed cybersecurity, risk, privacy, audit, technology, EC-Council, and Florida professional credentials link directly to their verification sources.</p></div><VerifiedCredentials /></section>
        <section className="about-proof-section" aria-labelledby="recognition-heading">
          <div className="about-proof-heading"><div><p className="about-kicker">AWARDS &amp; RECOGNITION</p><h2 id="recognition-heading">Recognized leadership across cybersecurity and enterprise risk.</h2></div><p>Selected honors reflect contributions to cybersecurity, ethical hacking, enterprise risk, and executive leadership.</p></div>
        ...
        <section className="about-proof-section about-proof-media" aria-labelledby="leadership-heading">
          <div className="about-proof-heading"><div><p className="about-kicker">LEADERSHIP IN PRACTICE</p><h2 id="leadership-heading">Selected appearances and professional recognition.</h2></div><p>Panels, fireside discussions, executive recognition, and Hall of Fame honors provide a concise view of public leadership in practice.</p></div>
        ...
        <section className="about-proof-section about-proof-books" aria-labelledby="books-heading">
          <div className="about-proof-heading"><div><p className="about-kicker">PUBLISHED AUTHOR</p><h2 id="books-heading">Leadership ideas for institutions worthy of trust.</h2></div><p>Dr. Blanchard&apos;s writing examines executive stewardship, cybersecurity leadership, institutional systems, and accountability.</p></div>
