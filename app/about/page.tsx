    ...
    <>
      ...
      <main className="about-page about-executive-page enterprise-page-main">
        ...
        <section className="about-proof-section about-proof-media" aria-labelledby="leadership-heading">
          <div className="about-proof-heading"><div><p className="about-kicker">LEADERSHIP IN PRACTICE</p><h2 id="leadership-heading">Selected completed engagements and leadership evidence.</h2></div><p>Completed panels, fireside discussions, executive recognition, and Hall of Fame imagery remain visible as part of the executive profile.</p></div>
