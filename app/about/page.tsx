...
export default function AboutPage() {
  return <main className="about-page">
    ...
    <section className="leadership-media"><div className="leadership-media-heading"><p className="about-kicker">LEADERSHIP IN PRACTICE</p><h2>Recognition, perspective, and public conversation.</h2><p>Selected recognition and speaking moments presented without former or current employer identifiers.</p></div><div className="leadership-media-grid"><article><img src="/leadership/ceh-hall-of-fame-2025.png" alt="Dr. Jody Blanchard CEH Hall of Fame Top 100 2025 recognition" /><h3>CEH Hall of Fame, 2025</h3></article><article><img src="/leadership/global-leadership-award-2025.png" alt="Dr. Jody Blanchard global leadership award 2025 recognition" /><h3>Global leadership distinction, 2025</h3></article><article><img src="/leadership/technology-talks-no-employer.png" alt="Dr. Jody Blanchard technology workforce panel appearance" /><h3>Technology leadership panel</h3></article><article><img src="/leadership/fireside-chat-no-employer.png" alt="Dr. Jody Blanchard cybersecurity return on investment fireside chat" /><h3>Cybersecurity return on investment fireside chat</h3></article></div></section>

    <section className="interview-feature"><div><p className="about-kicker">FEATURED INTERVIEW</p><h2>Cybersecurity leadership in conversation.</h2><p>Watch Dr. Jody Blanchard discuss the thinking, leadership, and practical perspective that inform Obserra&apos;s work. The embedded player uses YouTube&apos;s privacy-enhanced domain; no video file is hosted by this site.</p><a className="about-outline" href="https://www.youtube.com/watch?v=95IRygw4-NQ" target="_blank" rel="noreferrer">Watch on YouTube</a></div><div className="interview-frame"><span className="interview-watermark" aria-hidden="true">PROPERTY OF OBSERRA · AUTHORIZED VIEWING</span><iframe src="https://www.youtube-nocookie.com/embed/95IRygw4-NQ?rel=0&amp;modestbranding=1&amp;playsinline=1" title="Interview with Dr. Jody Blanchard" loading="lazy" referrerPolicy="strict-origin-when-cross-origin" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div></section>
