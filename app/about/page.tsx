...
export default function AboutPage() {
  const aboutSchema = {
    ...
    "@graph": [
      { "@type": "AboutPage", url: "https://www.obserrallc.com/about", name: `About Dr. Jody Blanchard | ${LEGAL_ENTITY_NAME}`, description: `Executive biography and verified professional profile for Dr. Jody Blanchard, founder and Chief Executive Officer of ${LEGAL_ENTITY_NAME}.`, isPartOf: { "@id": "https://www.obserrallc.com/#website" } },
      { "@type": "Person", name: "Dr. Jody Blanchard", jobTitle: "Founder and Chief Executive Officer", worksFor: { "@type": "Organization", name: LEGAL_ENTITY_NAME, url: "https://www.obserrallc.com" }, image: "https://www.obserrallc.com/leadership/dr-jody-blanchard-about.png", url: "https://www.obserrallc.com/about", award: "EC-Council Certified Ethical Hacker Hall of Fame 2025", hasCredential: [
    ...
    <>
      ...
      <main className="about-page about-executive-page enterprise-page-main">
        ...
        <section className="about-executive-hero">
          <div className="about-executive-portrait"><Image src="/leadership/dr-jody-blanchard-about.png" width={266} height={466} quality={95} sizes="(max-width: 800px) 76vw, 320px" priority alt={`Dr. Jody Blanchard, Founder and Chief Executive Officer of ${LEGAL_ENTITY_NAME}`} /></div>
          <div className="about-executive-copy">
            <p className="about-kicker">EXECUTIVE BIOGRAPHY</p><h1>Dr. Jody Blanchard</h1>
        ...
        <section className="about-proof-section about-proof-credentials" aria-labelledby="credentials-heading"><div className="about-proof-heading"><div><p className="about-kicker">VERIFIED CREDENTIALS &amp; LICENSES</p><h2 id="credentials-heading">The professional evidence stays visible.</h2></div><p>Issuer-backed cybersecurity, risk, privacy, audit, technology, EC-Council, and Florida professional credentials remain on the page and link to their verification sources.</p></div><VerifiedCredentials /></section>
        <section className="about-proof-section" aria-labelledby="recognition-heading">
          <div className="about-proof-heading"><div><p className="about-kicker">AWARDS &amp; RECOGNITION</p><h2 id="recognition-heading">Recognized executive leadership and cybersecurity impact.</h2></div><p>Every existing award image remains visible. Scroll the rail horizontally to review the complete recognition set without extending the page vertically.</p></div>
          <div className="about-proof-rail about-award-rail">{recognition.map(([label, award, image]) => <article key={award} className="about-proof-card about-award-card"><Image src={image} alt={`${award} recognition badge`} width={420} height={260} sizes="(max-width: 700px) 74vw, 300px" /><span>{label}</span><h3>{award}</h3></article>)}<article className="about-proof-card about-award-card about-award-certificate" id="ceh-hall-of-fame-title"><Image src="/recognition/ceh-hall-of-fame-2025-certificate.jpg" width={1750} height={1383} alt="EC-Council CEH Hall of Fame 2025 certificate presented to Jody Blanchard, certificate HOF-2025-1500089" sizes="(max-width: 700px) 76vw, 330px" /><span>ISSUER-BACKED CERTIFICATE</span><h3>EC-Council Certified Ethical Hacker Hall of Fame 2025</h3><a href="https://www.eccouncil.org/ceh-hall-of-fame-2025/" target="_blank" rel="noreferrer">Verify with EC-Council</a></article></div>
        </section>
        <section className="about-proof-section about-proof-media" aria-labelledby="leadership-heading">
          <div className="about-proof-heading"><div><p className="about-kicker">PUBLIC LEADERSHIP &amp; MEDIA</p><h2 id="leadership-heading">Selected appearances and leadership evidence.</h2></div><p>Completed panels, fireside discussions, executive recognition, and Hall of Fame imagery remain visible as part of the executive profile.</p></div>
        ...
        <section className="about-proof-section about-proof-books" aria-labelledby="books-heading">
          <div className="about-proof-heading"><div><p className="about-kicker">PUBLISHED AUTHOR</p><h2 id="books-heading">Books by Dr. Jody Blanchard.</h2></div><p>Executive writing on cybersecurity leadership, institutional systems, and accountability. Purchase links remain prominent and clearly separated from non-commerce actions.</p></div>
          <div className="about-books-grid"><article className="about-book-card"><Image src="/books/cyberbulleys-front.png" width={350} height={520} alt="Cover of CyberBulleys: A CISO's Guide to Doing Cybersecurity" /><div><span>CYBERSECURITY LEADERSHIP</span><h3>CyberBulleys: A CISO&apos;s Guide to Doing Cybersecurity</h3><p>By Dr. Jody Blanchard</p><a className="executive-buy-button" href="https://www.amazon.com/CyberBulleys-CISOs-Guide-Doing-Cybersecurity/dp/B0DT7L55JG" target="_blank" rel="noreferrer">Buy now</a></div></article><article className="about-book-card"><Image src="/books/break-the-system-front.png" width={350} height={520} alt="Cover of Break the System" /><div><span>LEADERSHIP &amp; SYSTEMS</span><h3>Break the System</h3><p>By Dr. Jody Blanchard</p><a className="executive-buy-button" href="https://www.amazon.com/Break-System-Jody-Blanchard/dp/B0G2Q1CX8R" target="_blank" rel="noreferrer">Buy now</a></div></article></div>
        </section>
