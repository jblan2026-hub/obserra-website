...
const leadershipMedia = [
  {
    title: "Global leadership distinction, 2025",
    summary: "Industry-recognized executive leadership achievement in cybersecurity and enterprise risk governance.",
    label: "Executive recognition",
    image: "/leadership/global-leadership-award-2025.png",
    alt: "Dr. Jody Blanchard global leadership award 2025 recognition"
  },
  {
    title: "Technology leadership panel",
    summary: "Public panel perspective on workforce transformation, governance, and strategic technology execution.",
    label: "Executive panel",
    image: "/leadership/technology-talks-no-employer.png",
    alt: "Dr. Jody Blanchard technology workforce panel appearance"
  },
  {
    title: "Cybersecurity return on investment fireside chat",
    summary: "Executive conversation on measurable cybersecurity value, accountability, and business-growth alignment.",
    label: "Fireside discussion",
    image: "/leadership/fireside-chat-neutral.png",
    alt: "Dr. Jody Blanchard cybersecurity return on investment fireside chat"
  }
];
...
export default function AboutPage() {
  ...
  return <main className="about-page">
    ...
    <section className="about-hero"><div className="about-grid" /><div className="about-hero-copy"><p className="about-kicker">OBSERRA LEADERSHIP</p><h1>Clear leadership for complex security decisions.</h1><p>Obserra Executive Protection &amp; Intelligence LLC unites cybersecurity, protective intelligence, executive protection, and practical operational discipline so leaders can move from risk to a defensible, accountable response.</p><div className="about-actions"><a href="mailto:info@obserrallc.com?subject=Obserra%20Consultation" className="about-button">Start a confidential conversation</a><a href="/academy" className="about-link">Explore Academy</a></div></div><aside className="about-signal"><span>LEADERSHIP</span><strong>Global cyber, intelligence<br />&amp; security experience</strong><p>Built for organizations where the decision and outcome both carry material impact.</p></aside></section>

    <section className="about-profile"><div className="founder-profile-card"><div className="profile-visual profile-photo-frame"><Image className="profile-photo" src="/leadership/dr-jody-blanchard-executive.webp" width={1200} height={1500} quality={95} sizes="(max-width: 800px) 86vw, 360px" priority alt="Dr. Jody Blanchard, Founder and CEO of Obserra Executive Protection and Intelligence LLC" /></div><div className="profile-photo-label"><span>DR. JODY BLANCHARD</span><strong>FOUNDER &amp; CEO</strong><small>CYBER, SECURITY, AND INTELLIGENCE</small></div></div><div><p className="about-kicker">FOUNDER PROFILE</p><h2>Executive expertise buyers can trust in high-stakes environments.</h2><p>Dr. Jody Blanchard is an executive cybersecurity and enterprise risk advisor trusted by boards, C-suite leaders, and operating teams to turn complex exposure into clear, accountable action. With more than 25 years of leadership across Fortune 500 environments, military intelligence, and regulated industries, he helps organizations protect enterprise value while improving decision speed and resilience.</p><p>His qualifications combine global CISO leadership, intelligence and investigative discipline, protective risk judgment, and business-aligned governance execution. As Founder of Obserra, he leads confidential advisory engagements designed to deliver measurable outcomes, stronger executive confidence, and practical results that stand up under scrutiny. He is also the author of <em>CyberBulleys: A CISO's Guide to Doing Cybersecurity</em> and <em>Break the System</em>.</p><a className="about-button" href="mailto:info@obserrallc.com?subject=Executive%20Consultation%20with%20Obserra">Book an executive consultation</a></div></section>
    ...
    <section className="credentials"><div className="credentials-heading"><p className="about-kicker">LICENSES &amp; PROFESSIONAL CREDENTIALS</p><h2>Verified qualifications with enterprise relevance.</h2><p>Credentials are presented in a professional format to highlight executive readiness, technical depth, and compliance-aligned expertise.</p></div><div className="credentials-grid">{credentials.map(([name, acronym]) => <article key={acronym}><div className="credential-code">{acronym}</div><h3>{name}</h3><div className="credential-meta">Professional credential</div></article>)}</div></section>
    ...
    <section className="about-cta"><p className="about-kicker">ENGAGE OBSERRA</p><h2>Bring proven expertise to cybersecurity, protection, intelligence, and workforce readiness priorities.</h2><p>Explore EIOS, build a secure technology solution, develop your team through Obserra Academy, or begin a confidential conversation about cybersecurity, protective intelligence, executive protection, and enterprise risk.</p><div><a className="about-button" href="mailto:info@obserrallc.com?subject=Obserra%20Consultation">Talk with Obserra</a><a className="about-outline" href="/academy">View Academy courses</a></div></section>
