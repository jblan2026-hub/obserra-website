      ...
      <main className="about-page about-executive-page enterprise-page-main">
        ...
        <section className="about-executive-hero">
          ...
          <div className="about-executive-copy">
            ...
            <p className="about-executive-lede">Executive cybersecurity leader, retired U.S. Army intelligence officer, author, educator, and enterprise advisor with experience leading complex security, risk, governance, and transformation work in regulated and high-consequence environments.</p>
            <p className="about-executive-lede">His work centers on helping boards and executive teams connect cybersecurity, intelligence, governance, operational risk, technology investment, and accountable execution into clearer business decisions.</p>
        ...
        <section className="about-executive-details" aria-labelledby="about-detail-heading">
          <div className="about-executive-heading"><p className="about-kicker">VERIFIED PROFILE</p><h2 id="about-detail-heading">Credentials, recognition, public leadership, and publications.</h2><p>Select a section for the complete evidence and imagery without turning the page into an endless scroll.</p></div>
          <div className="about-executive-detail-grid">
            <ExecutiveDetailModal eyebrow="VERIFIED EVIDENCE" title="Credentials & professional licenses" summary="Issuer-backed cybersecurity, risk, privacy, audit, technology, and Florida professional credentials." triggerLabel="Open credentials"><div className="about-modal-evidence about-modal-credentials"><VerifiedCredentials /></div></ExecutiveDetailModal>

            <ExecutiveDetailModal eyebrow="RECOGNITION" title="Awards & recognition" summary="Industry recognition, award imagery, Hall of Fame evidence, and issuer verification." triggerLabel="Open recognition">
              <div className="about-modal-evidence">
                <div className="about-modal-recognition-grid">{recognition.map(([label, award, image]) => <article key={award}><Image src={image} alt={`${award} recognition badge`} width={420} height={260} sizes="(max-width: 700px) 80vw, 300px" /><span>{label}</span><h3>{award}</h3></article>)}</div>
                <article className="about-modal-ceh" id="ceh-hall-of-fame-title">
                  ...
                  <div><p className="about-kicker">ISSUER-BACKED RECOGNITION</p><h3>EC-Council Certified Ethical Hacker Hall of Fame 2025</h3><p>Presented to Jody Blanchard for outstanding performance and contribution to the field of ethical hacking.</p><dl><div><dt>Certificate</dt><dd>HOF-2025-1500089</dd></div><div><dt>Issue date</dt><dd>July 1, 2025</dd></div></dl><a href="https://www.eccouncil.org/ceh-hall-of-fame-2025/" target="_blank" rel="noreferrer">Verify on EC-Council</a></div>
                  <a href="https://www.eccouncil.org/ceh-hall-of-fame-2025/" target="_blank" rel="noreferrer" className="about-modal-certificate"><Image src="/recognition/ceh-hall-of-fame-2025-certificate.jpg" width={1750} height={1383} alt="EC-Council CEH Hall of Fame 2025 certificate presented to Jody Blanchard, certificate HOF-2025-1500089" /></a>
                </article>
              </div>
            </ExecutiveDetailModal>

            <ExecutiveDetailModal eyebrow="PUBLIC LEADERSHIP" title="Speaking, media & completed engagements" summary="Selected panels, fireside discussions, executive recognition, and public leadership appearances." triggerLabel="Open media" actionHref="/speaking" actionLabel="View speaker profile">
              <div className="about-modal-evidence">
                <article className="about-modal-feature"><Image src="/leadership/ceh-hall-of-fame-2025.png" alt="Dr. Jody Blanchard CEH Hall of Fame 2025 magazine cover" width={680} height={848} sizes="(max-width: 700px) 74vw, 360px" /><div><span>CEH HALL OF FAME · TOP 100</span><h3>CEH Hall of Fame 2025 magazine cover</h3><p>EC-Council recognition for outstanding performance and contribution to ethical hacking.</p></div></article>
                <div className="about-modal-media-grid">{leadershipMedia.map((item) => <article key={item.title}><Image src={item.image} alt={item.alt} width={720} height={480} sizes="(max-width: 700px) 80vw, 320px" /><span>{item.label}</span><h3>{item.title}</h3><p>{item.summary}</p></article>)}</div>
              </div>
            </ExecutiveDetailModal>

            <ExecutiveDetailModal eyebrow="PUBLISHED AUTHOR" title="Books" summary="Executive writing on cybersecurity leadership, institutional systems, and accountability." triggerLabel="Open books">
              <div className="about-modal-evidence about-modal-books">
                <article><Image src="/books/cyberbulleys-front.png" width={350} height={520} alt="Cover of CyberBulleys: A CISO's Guide to Doing Cybersecurity" /><div><span>CYBERSECURITY LEADERSHIP</span><h3>CyberBulleys: A CISO&apos;s Guide to Doing Cybersecurity</h3><p>By Dr. Jody Blanchard</p><a className="executive-buy-button" href="https://www.amazon.com/CyberBulleys-CISOs-Guide-Doing-Cybersecurity/dp/B0DT7L55JG" target="_blank" rel="noreferrer">Buy now</a></div></article>
                <article><Image src="/books/break-the-system-front.png" width={350} height={520} alt="Cover of Break the System" /><div><span>LEADERSHIP &amp; SYSTEMS</span><h3>Break the System</h3><p>By Dr. Jody Blanchard</p><a className="executive-buy-button" href="https://www.amazon.com/Break-System-Jody-Blanchard/dp/B0G2Q1CX8R" target="_blank" rel="noreferrer">Buy now</a></div></article>
              </div>
            </ExecutiveDetailModal>
          </div>
        </section>
