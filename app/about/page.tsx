...
const recognition = [
  ["GLOBAL CYBER LEADERSHIP", "Top Global CISO in the World Â· 2023", "/recognition/top-global-ciso-2023.jpg"],
  ["GLOBAL CYBER LEADERSHIP", "Top Global CISO in the World Â· 2024", "/recognition/top-global-ciso-2024.jpg"],
  ["GLOBAL CYBER LEADERSHIP", "Top Global CISO in the World Â· 2025", "/recognition/top-global-ciso-2025.jpg"],
  ["EXECUTIVE COMMUNITY", "A100 Accelerated Winner Â· 2024", "/recognition/a100-2024.jpg"],
  ["EXECUTIVE COMMUNITY", "A100 Accelerated Winner Â· 2026", "/recognition/a100-2026.jpg"],
];
...
export default function AboutPage() {
  return <main className="about-page">
    ...
    <section className="about-hero"><div className="about-grid" /><div><p className="about-kicker">OBSERRA LEADERSHIP</p><h1>Experience you can put to work when the decision matters.</h1><p>Obserra Executive Protection &amp; Intelligence LLC is led by Dr. Jody Blanchard, an award winning cybersecurity and intelligence executive who brings enterprise leadership, protective thinking, and practical operational discipline to complex security challenges.</p><div className="about-actions"><a href="mailto:info@obserrallc.com?subject=Obserra%20Consultation" className="about-button">Start a confidential conversation <span>â†’</span></a><a href="/academy" className="about-link">Explore Academy <span>â†’</span></a></div></div><aside className="about-signal"><span>DR. JODY BLANCHARD</span><strong>Founder &amp; Managing Director</strong><p>Global cybersecurity leader Â· U.S. Army veteran Â· intelligence professional Â· educator Â· author</p></aside></section>

    <section className="about-profile"><div className="profile-visual profile-photo-frame"><Image className="profile-photo" src="/leadership/dr-jody-blanchard.jpg" fill sizes="(max-width: 1000px) 100vw, 42vw" priority alt="Dr. Jody Blanchard, founder of Obserra Executive Protection and Intelligence LLC" /><div className="profile-photo-label"><span>DR. JODY BLANCHARD</span><strong>FOUNDER &amp; MANAGING DIRECTOR</strong><small>CYBER Â· SECURITY Â· INTELLIGENCE</small></div></div><div><p className="about-kicker">FOUNDER PROFILE</p><h2>A security executive shaped by real decisions and real consequence.</h2><p>Dr. Jody Blanchard brings senior cybersecurity leadership together with a background in military intelligence, protective operations, governance, and education. He helps leaders turn complex risk into a clear, accountable response that can be understood, acted on, and defended.</p><p>His experience spans global enterprise cybersecurity, intelligence, investigations, risk governance, and operational leadership. Supported by doctoral study in organizational leadership, graduate study in information management and cybersecurity, and a criminal justice foundation, Dr. Blanchard brings both strategic range and practical judgment to the work. He is also the author of <em>Cyber Bullies: A CISOâ€™s Guide to Doing Cybersecurity</em> and <em>Break the System</em>.</p><a className="about-button" href="mailto:info@obserrallc.com?subject=Executive%20Consultation%20with%20Obserra">Discuss an executive engagement <span>â†’</span></a></div></section>

    <section className="books"><div className="books-heading"><p className="about-kicker">BOOKS BY DR. JODY BLANCHARD</p><h2>Ideas for leaders who need to make security work.</h2><p>Explore Dr. Blanchardâ€™s writing on cybersecurity leadership, risk, and the systems that shape real world outcomes.</p></div><div className="books-grid"><article><div className="book-cover actual-cover"><Image src="/books/cyberbulleys-front.png" fill sizes="(max-width: 650px) 220px, 210px" alt="Cover of CyberBulleys: A CISO's Guide to Doing Cybersecurity by Jody Blanchard" /></div><div><p>CYBERSECURITY LEADERSHIP</p><h3>CyberBulleys: A CISOâ€™s Guide to Doing Cybersecurity</h3><span>By Dr. Jody Blanchard</span><a href="https://www.amazon.com/CyberBulleys-CISOs-Guide-Doing-Cybersecurity/dp/B0DT7L55JG/ref=tmm_hrd_swatch_0?_encoding=UTF8&dib_tag=se&dib=eyJ2IjoiMSJ9.lbBo9OG_7m9OqamlDKL8lcMOH0cC1mhTC0Mf6TSgpyQCmPH6C9UZsoCh6VWMCF54zoWD9EFh3EVtj_Th_rZuUJpqqXatJCahBLQCMEg-giw.CApDX1AMgKNZHlis97LDm55l179wsWv5sdc4feL7Ew0&qid=1785733313&sr=8-2" target="_blank" rel="noreferrer">Buy on Amazon <b>â†—</b></a></div></article><article><div className="book-cover actual-cover"><Image src="/books/break-the-system-front.png" fill sizes="(max-width: 650px) 220px, 210px" alt="Cover of Break the System by Jody Blanchard" /></div><div><p>LEADERSHIP &amp; SYSTEMS</p><h3>Break the System</h3><span>By Dr. Jody Blanchard</span><a href="https://www.amazon.com/Break-System-Jody-Blanchard/dp/B0G2Q1CX8R/ref=tmm_hrd_swatch_0?_encoding=UTF8&dib_tag=se&dib=eyJ2IjoiMSJ9.lbBo9OG_7m9OqamlDKL8lcMOH0cC1mhTC0Mf6TSgpyQCmPH6C9UZsoCh6VWMCF54zoWD9EFh3EVtj_Th_rZuUJpqqXatJCahBLQCMEg-giw.CApDX1AMgKNZHlis97LDm55l179wsWv5sdc4feL7Ew0&qid=1785733313&sr=8-1" target="_blank" rel="noreferrer">Buy on Amazon <b>â†—</b></a></div></article></div></section>
    ...
    <section className="leadership-media"><div className="leadership-media-heading"><p className="about-kicker">LEADERSHIP IN PRACTICE</p><h2>Recognition, perspective, and public conversation.</h2><p>Selected recognition and speaking moments presented without former or current employer identifiers.</p></div><div className="leadership-media-grid"><article><img src="/leadership/ceh-hall-of-fame-2025.png" alt="Jody Blanchard CEH Hall of Fame Top 100 2025 recognition" /><h3>CEH Hall of Fame Â· 2025</h3></article><article><img src="/leadership/global-leadership-award-2025.png" alt="Jody Blanchard global leadership award 2025 recognition" /><h3>Global leadership distinction Â· 2025</h3></article><article><img src="/leadership/technology-talks-no-employer.png" alt="Jody Blanchard technology workforce panel appearance" /><h3>Technology leadership panel</h3></article><article><img src="/leadership/fireside-chat-no-employer.png" alt="Jody Blanchard cybersecurity ROI fireside chat" /><h3>Cybersecurity ROI fireside chat</h3></article></div></section>

    <section className="interview-feature"><div><p className="about-kicker">FEATURED INTERVIEW</p><h2>Cybersecurity leadership in conversation.</h2><p>Watch Dr. Jody Blanchard discuss the thinking, leadership, and practical perspective that inform Obserraâ€™s work.</p><a className="about-outline" href="https://www.youtube.com/watch?v=95IRygw4-NQ" target="_blank" rel="noreferrer">Watch on YouTube <span>â†—</span></a></div><div className="interview-frame"><iframe src="https://www.youtube-nocookie.com/embed/95IRygw4-NQ" title="Interview with Dr. Jody Blanchard" loading="lazy" referrerPolicy="strict-origin-when-cross-origin" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div></section>
