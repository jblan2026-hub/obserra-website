...
export default function EiosShowcase() {
  ...
  return <main className="eios-page" onCopy={(event) => event.preventDefault()} onContextMenu={(event) => event.preventDefault()}>
    ...
    <section className="eios-hero" id="experience">
      ...
      <div className="eios-hero-copy"><p className="eios-eyebrow">PROPERTY OF OBSERRA · ENTERPRISE INTELLIGENCE OPERATING SYSTEM</p><h1>From fragmented context<br />to <em>governed, verified action.</em></h1><p className="eios-lede">EIOS is the enterprise intelligence and execution system from OBSERRA EXECUTIVE PROTECTION &amp; INTELLIGENCE LLC. It helps leadership teams connect systems, measure risk and business impact, authorize action, and verify outcome integrity without replacing core enterprise platforms.</p><div className="eios-actions"><a href="#showcase" className="eios-button">Review EIOS product views</a><a href="#connect" className="eios-text-link">Request enterprise briefing</a></div><p className="eios-restriction">EIOS visuals and product artifacts are proprietary. Public views are controlled representations and do not expose customer data, credentials, or live production architecture.</p></div>
