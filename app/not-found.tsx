...
export default function NotFound() {
  return <main className="commercial-page"><div className="commercial-shell">
    ...
    <section className="commercial-grid">
      <article className="commercial-card"><span>Platform</span><h2>{APPLICATIONS_BRAND_NAME}</h2><p>Explore enterprise applications, {EIOS_BRAND_NAME}, governance, risk, assurance, and intelligence solutions.</p><Link href="/apps">View applications</Link></article>
