...
export default function SignInPage() {
  return <main className="auth-shell">
    <section className="auth-card">
      ...
      <p>This private sign-in is only for the Obserra owner control room. Academy purchases return directly to the paid course and do not require a website account.</p>
