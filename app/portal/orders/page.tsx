  ...
  return (
    <main className={shell}>
      ...
      <section className="bg-[radial-gradient(circle_at_88%_8%,#1e648b4a,transparent_34%)] px-[max(5vw,24px)] pb-9 pt-16 md:pt-20">
        ...
        <span className="mt-5 block max-w-4xl text-lg leading-8 text-[#b8d5e6]">Records are loaded directly from Stripe using your authenticated {LEGAL_ENTITY_NAME} account. No order, invoice, subscription, balance, or receipt is generated by the website.</span>
      </section>
