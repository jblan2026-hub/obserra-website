...
export const metadata: Metadata = {
  title: "Certifications and Professional Credentials | Obserra",
  description: "Review issuer backed cybersecurity, risk, privacy, audit, AI governance, and protective services credentials held by Obserra founder Dr. Jody Blanchard.",
    ...
    <main className="about-page">
      <header className="about-nav">
        ...
        <nav>
          ...
          <Link href="/contact?interest=enterprise-consultation" className="about-nav-cta">Talk with Obserra</Link>
        </nav>
      </header>
      ...
      <section className="about-hero" style={{ minHeight: 430 }}>
        ...
        <div className="about-hero-copy">
          ...
          <h1>Verified qualifications behind Obserra leadership.</h1>
      ...
      <section className="about-cta">
        <p className="about-kicker">ABOUT OBSERRA</p>
        <h2>Credentials support the work. Executive judgment determines how they are applied.</h2>
        <p>Learn more about Obserra leadership, experience, business capabilities, and the operating philosophy behind our services and products.</p>
        <div><Link className="about-button" href="/about">Review company leadership</Link></div>
      </section>

      <footer className="about-footer">
        <Image src="/brand/obserra-logo.png" width={180} height={35} alt="Obserra Executive Protection and Intelligence LLC" />
