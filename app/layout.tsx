...
export const metadata: Metadata = {
  ...
  title: { default: "Obserra | Executive Intelligence, Cybersecurity and Protection", template: "%s | Obserra" },
  ...
  openGraph: { siteName: "Obserra", type: "website", url: "https://www.obserrallc.com", title: "Obserra | Executive Intelligence, Cybersecurity and Protection", description: "Executive cybersecurity advisory, protective intelligence, secure enterprise applications, and professional training.", locale: "en_US", images: [{ url: "/brand/visuals/obserra-eios-intelligence-hero.png", width: 1672, height: 941, alt: "Obserra enterprise intelligence and cybersecurity" }] },
  twitter: { card: "summary_large_image", title: "Obserra | Executive Intelligence, Cybersecurity and Protection", description: "Executive cybersecurity advisory, protective intelligence, enterprise applications, and professional training.", images: ["/brand/visuals/obserra-eios-intelligence-hero.png"] },
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const structuredData = {
    ...
    "@graph": [
      { "@type": "Organization", "@id": "https://www.obserrallc.com/#organization", name: "Obserra Executive Protection & Intelligence LLC", alternateName: "Obserra", url: "https://www.obserrallc.com", logo: "https://www.obserrallc.com/brand/obserra-logo.png", description: "Executive cybersecurity advisory, protective intelligence, secure enterprise applications, and professional training.", email: "info@obserrallc.com", contactPoint: [{ "@type": "ContactPoint", contactType: "sales", email: "info@obserrallc.com", availableLanguage: ["en"], areaServed: "US" }] },
      { "@type": "WebSite", "@id": "https://www.obserrallc.com/#website", name: "Obserra", url: "https://www.obserrallc.com", publisher: { "@id": "https://www.obserrallc.com/#organization" }, inLanguage: "en-US" },
    ],
  };
