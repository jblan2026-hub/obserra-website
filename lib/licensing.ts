...
export const productEntitlementRegistry: ProductEntitlementDefinition[] = [
  {
    ...
    name: "Launch Obserra EPI EIOS",
    description: "Permits an assigned user to launch the Obserra EPI EIOS SaaS application.",
    effect: "allow",
  ...
  },
  {
    ...
    description: "Permits secure download of an approved Obserra EPI EIOS release when the deployment model supports customer-hosted delivery.",
    effect: "allow",
