...
import dataProtection from "../compliance/data-protection-compliance-crosswalk.json";
...
const auditableDocuments: AuditableDocument[] = [
  ...
  { id: "data-protection-crosswalk", category: "Privacy", title: "Data Protection Compliance Crosswalk", source: "compliance/data-protection-compliance-crosswalk.json", description: "Data governance, classification, minimization, encryption, retention, deletion, recovery, incident response, and continuous assurance mappings.", exportable: true, evidenceType: "crosswalk" },
  ...
  { id: "governance-500x", category: "Governance", title: "500-Control Governance Production Gate", source: "scripts/governance-production-500x.mjs", description: "Five hundred discrete release assertions spanning governance, security, privacy, PCI, data protection, exports, identity, resilience, and audit evidence.", exportable: true, evidenceType: "test" },
