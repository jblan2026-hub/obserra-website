...
do $identity_provider_subject_index_rehearsal$
begin
  if not exists (
    select 1
    ...
    raise exception 'identity provider subject rollback rehearsal failed';
  end if;
end;
$identity_provider_subject_index_rehearsal$;
